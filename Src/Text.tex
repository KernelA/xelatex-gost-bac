...
\newcommand{\figures}{\total{totfigures}~рисунок}
\newcommand{\nofigures}{рисунков нет}

\newcommand{\tables}{\total{tottables}~таблица}
\newcommand{\notables}{таблиц нет}

\newcommand{\appendices}{\total{totappendix}~приложение}
\newcommand{\noappendices}{приложений нет}

\newcommand{\refrences}{\total{totreferences}~источника}
